...
/** Sorts the items in an array into ascending order.
 ...
 @param first the first index of theArray.
 @param last The last index of theArray. */
...
template<class Comparable>
int sortFirstMiddleLast(vector<Comparable> &theArray, int first, int last)
{
...
template<class Comparable>
int partition(vector<Comparable> &theArray, int first, int last)
{
...
template<class Comparable>
void quickSort(vector<Comparable> &theArray, int first, int last)
{
